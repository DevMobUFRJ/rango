    ...
    return Stack(
      children: <Widget>[
        ...
        Container(
          ...
          child: AutoSizeText(
            'Você ainda não recebeu pedidos hoje!\n\nAproveite para gerenciar suas quentinhas e o cardápio de hoje na aba de quentinhas ou configurar horário de funcionamento, localização e outras coisas na aba de perfil!',
            style: GoogleFonts.montserrat(
