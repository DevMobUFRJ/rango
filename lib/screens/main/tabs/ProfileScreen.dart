...
class ProfileScreen extends StatefulWidget {
  ...
  ProfileScreen(this.usuario, this.hasInternet);
                    ...
                    child: Container(
                      child: StreamBuilder(
                        stream: Repository.instance
                            .getClientStream(widget.usuario.id),
                        builder: (context,
                          ...
                          return ListView.separated(
                            ...
                            itemBuilder: (ctx, index) => StreamBuilder(
                              ...
                              builder: (
                                ...
                                var sellerSnapshotdata = sellerSnapshot.data
                                ...
                                return GestureDetector(
                                  onTap: () => pushNewScreen(
                                    ...
                                    withNavBar: false,
                                    screen:
                                        SellerProfile(seller.id, seller.name),
                                    pageTransitionAnimation:
                                        PageTransitionAnimation.cupertino,
                                  ),
                                  child: Container(
